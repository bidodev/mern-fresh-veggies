...
const AddForm = () => {
  ...
  return (
    <form className="add-product-form" onSubmit={handleAddProduct}>
      <FormInput name="name" type="name" value={name} required label="name" handleInputValue={handleInputValue} />
      <FormInput name="type" type="type" value={type} required label="type" handleInputValue={handleInputValue} />
      <FormInput
        name="description"
        type="description"
        value={description}
